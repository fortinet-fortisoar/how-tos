...
# setup
setup_connectors_data = Template(
    '>* **$connector_name** - $connector_description. To configure and use the $connector_name connector, refer to [Configuring $connector_name]($connector_doc_link)')
